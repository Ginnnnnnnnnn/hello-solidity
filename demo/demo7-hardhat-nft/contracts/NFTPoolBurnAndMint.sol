...
import {WarppendMyToken} from "./WarppendMyToken.sol";

contract NFTPoolBurnAndMint is CCIPReceiver, OwnerIsCreator {
    IERC20 private s_linkToken;

    WarppendMyToken public wnft;
    ...
    function _ccipReceive(
        ...
        // 铸造NFT
        wnft.miniTokenWithSpecificTokenId(newOwner, tokenId);
        // 发送消息
